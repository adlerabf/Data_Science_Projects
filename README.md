...
| Regressão Linear do Indice de Fundos Imobiliários (IFIX)      | Criação de avaliação de um modelo de Regressão Linear para prever o valor do IFIX | [Acesso](https://github.com/adlerabf/Data_Science_Projects/blob/main/RegressaoIfix2.ipynb) | N/A |
