...
| Regressão Linear do Indice de Fundos Imobiliários (IFIX)      | Criação de avaliação de um modelo de Regressão Linear para prever o valor do IFIX. Dica: na célula que tiver o botão "Visualizar 1" clique para ver o gráfico | [Acesso](https://encurtador.com.br/uyY06) | N/A |
