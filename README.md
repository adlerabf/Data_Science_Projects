...
| Regressão Linear: Indice de Fundos Imobiliários (IFIX)      | Criação de avaliação de um modelo de Regressão Linear para prever o valor do IFIX. | [Acesso](https://databricks-prod-cloudfront.cloud.databricks.com/public/4027ec902e239c93eaaa8714f173bcfc/2339166480236072/766315610315070/1231540242270830/latest.html) | N/A |
...
| Brazil E-commerce Analysis | Análise exploratória, construção de modelo relacional e aplicação de modelos de ml | N/A | [Acesso](https://github.com/adlerabf/brazil-ecommerce-analysis.git) |
